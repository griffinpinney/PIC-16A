...
<!-- ![2048](./2048.png) -->
<!-- <img src="./2048.png" alt="2048" width="300"> -->
<div align="center">
  <img src="./2048.png" alt="2048" width="300" style="margin-bottom: 10px;">
</div>
...
It is an intimidating question for a few reasons.
 ...
 - There is math, the most disliked of all subjects!
 - The word "random".
...
<script>
  function respond_to_first_digit_of_power_of_two_submission() {
    ...
    if (submission === '1' || submission === '1.' || submission === '1.0' || submission === '1.00') {
      ...
      alert('Hmm. Go back to your chart and discuss what it is showing you with your friends.');
    }
  }
